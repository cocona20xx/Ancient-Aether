...
public class AncientAetherBiomeModifiers {
    ...
    public static void bootstrap(BootstrapContext<BiomeModifier> context) {
        ...
        context.register(AEROGEL_BLOBS_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(AETHER_QUARTZ_ORE_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(VALKYRUM_ORE_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(QUICKSOIL_COAST_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(GRAVITY_GRAVEL_COAST_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(WYND_ICE_COAST_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(AETHER_GRASS_PATCH_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_MEADOW_FLOWERS_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_GROVE_FLOWERS_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_FOREST_FLOWERS_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_WOODLAND_FLOWERS_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_MEADOW_TREES_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_GROVE_TREES_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_FOREST_TREES_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(SKYROOT_WOODLAND_TREES_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(BONUS_BERRY_BUSH_PATCH_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(VIOLET_AERCLOUD_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(CLOUDBED_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(WATER_LAKE_UNDERGROUND_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(CRYSTAL_ISLAND_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(WYNDCAPS_CRYSTAL_ISLAND_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(ELEVATED_CRYSTAL_ISLAND_BIOME_MODIFIER, new BiomeModifiers.AddFeaturesBiomeModifier(
        ...
        context.register(REMOVE_QUICKSOIL_SHELF_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
        ...
        context.register(REMOVE_GRASS_PATCH_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AetherTags.Biomes.IS_AETHER),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.GRASS_PATCH_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_TALL_GRASS_PATCH_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AetherTags.Biomes.IS_AETHER),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.TALL_GRASS_PATCH_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_WHITE_FLOWER_PATCH_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AetherTags.Biomes.IS_AETHER),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.WHITE_FLOWER_PATCH_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_PURPLE_FLOWER_PATCH_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AetherTags.Biomes.IS_AETHER),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.PURPLE_FLOWER_PATCH_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_SKYROOT_MEADOW_TREES_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AncientAetherTags.Biomes.HAS_SKYROOT_MEADOW_TREES),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.SKYROOT_MEADOW_TREES_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_SKYROOT_GROVE_TREES_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AncientAetherTags.Biomes.HAS_SKYROOT_GROVE_TREES),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.SKYROOT_GROVE_TREES_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_SKYROOT_FOREST_TREES_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AncientAetherTags.Biomes.HAS_SKYROOT_FOREST_TREES),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.SKYROOT_FOREST_TREES_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_SKYROOT_WOODLAND_TREES_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AncientAetherTags.Biomes.HAS_SKYROOT_WOODLAND_TREES),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.SKYROOT_WOODLAND_TREES_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));
        context.register(REMOVE_CRYSTAL_ISLAND_BIOME_MODIFIER, new BiomeModifiers.RemoveFeaturesBiomeModifier(
                biome.getOrThrow(AetherTags.Biomes.IS_AETHER),
                HolderSet.direct(placement.getOrThrow(AetherPlacedFeatures.CRYSTAL_ISLAND_PLACEMENT)),
                Set.of(GenerationStep.Decoration.values())
        ));

        context.register(AETHER_CAVE_BIOME_MODIFIER, new BiomeModifiers.AddCarversBiomeModifier(
                biome.getOrThrow(AncientAetherTags.Biomes.HAS_AETHER_CAVES),
                HolderSet.direct(carver.getOrThrow(AncientAetherCarvers.AETHER_CAVE)),
