    ...
    public void generate(@NotNull BiConsumer<ResourceLocation, LootTable.Builder> builder) {
        ...
        builder.accept(AncientAetherLoot.CHESTS_DUNGEON_BRONZE_DUNGEON_LOOT, LootTable.lootTable()
                ...
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 2.0F))
                        ...
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.CHESTS_DUNGEON_ARMOR_TRIMS).setWeight(2))
        ...
        builder.accept(AncientAetherLoot.CHESTS_DUNGEON_SENTRY_LABORATORY_REWARD, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(6.0F, 9.0F))
                        ...
                        .add(LootItem.lootTableItem(AetherBlocks.ENCHANTED_GRAVITITE.get()).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.CHESTS_DUNGEON_MOA_EGGS_COMMON).setWeight(2))
                        ...
                        .add(LootItem.lootTableItem(AncientAetherItems.WARRIOR_RING.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AncientAetherItems.WARRIOR_PENDANT.get()).setWeight(2))
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.CHESTS_DUNGEON_ARMOR_TRIMS))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_HELMET.get()))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_CHESTPLATE.get()))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_LEGGINGS.get()))
        ...
        builder.accept(AncientAetherLoot.CHESTS_DUNGEON_ANCIENT_DUNGEON, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_BERRY.get()).setWeight(4).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
                        .add(LootItem.lootTableItem(AetherItems.WHITE_APPLE.get()).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 3.0F))))
                        .add(LootItem.lootTableItem(AetherItems.HEALING_STONE.get()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AncientAetherItems.FESTIVE_GUMMY_SWET.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherItems.SKYROOT_MILK_BUCKET.get()))
                )
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(1.0F, 3.0F))
                        .add(LootItem.lootTableItem(AetherItems.ZANITE_GEMSTONE.get()).setWeight(6).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                        .add(LootItem.lootTableItem(AetherBlocks.ENCHANTED_GRAVITITE.get()).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_SWORD.get()))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_AXE.get()))
                        .add(LootItem.lootTableItem(AncientAetherItems.AERONAUTIC_DART_SHOOTER.get()))
                        .add(LootItem.lootTableItem(AetherItems.MUSIC_DISC_AETHER_TUNE.get()))
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.CHESTS_DUNGEON_ARMOR_TRIMS))
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.CHESTS_DUNGEON_MOA_EGGS_RARE))
                )
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(0.0F, 2.0F))
                        .add(LootItem.lootTableItem(AncientAetherBlocks.AEROGETIC_STONE).setWeight(3).apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
                        .add(LootItem.lootTableItem(AncientAetherBlocks.AERONAUTIC_STONE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
                        .add(LootItem.lootTableItem(AncientAetherBlocks.CORRUPTED_AERONAUTIC_STONE).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(3.0F, 6.0F))))
                        .add(LootItem.lootTableItem(AetherBlocks.AEROGEL).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 4.0F))))
                )
        );

        builder.accept(AncientAetherLoot.CHESTS_DUNGEON_ANCIENT_DUNGEON_REWARD, LootTable.lootTable()
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(2.0F, 4.0F))
                        .add(LootItem.lootTableItem(AetherItems.ENCHANTED_BERRY.get()).setWeight(2).apply(SetItemCountFunction.setCount(UniformGenerator.between(4.0F, 8.0F))))
                        .add(LootItem.lootTableItem(AetherItems.HEALING_STONE.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F))))
                        .add(LootItem.lootTableItem(AncientAetherItems.FESTIVE_GUMMY_SWET.get()).apply(SetItemCountFunction.setCount(UniformGenerator.between(2.0F, 5.0F))))
                )
                .withPool(LootPool.lootPool().setRolls(UniformGenerator.between(4.0F, 8.0F))
                        .add(LootItem.lootTableItem(AncientAetherItems.ANCIENT_SWORD.get()).setWeight(4))
                        .add(LootItem.lootTableItem(AncientAetherItems.AERONAUTIC_DART_SHOOTER.get()).setWeight(4))
                        .add(LootItem.lootTableItem(AncientAetherItems.ANCIENT_RING.get()).setWeight(4))
                        .add(LootItem.lootTableItem(AncientAetherItems.ANCIENT_PENDANT.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientAetherItems.GROWTH_RING.get()).setWeight(4))
                        .add(LootItem.lootTableItem(AncientAetherItems.GROWTH_PENDANT.get()).setWeight(3))
                        .add(LootItem.lootTableItem(AncientAetherItems.GROWTH_RING.get()).setWeight(4))
                        .add(LootItem.lootTableItem(AncientAetherItems.ANCIENT_ARMOR_TRIM_SMITHING_TEMPLATE.get()).setWeight(4))
                        .add(LootTableReference.lootTableReference(AncientAetherLoot.CHESTS_DUNGEON_MOA_EGGS_RARE).setWeight(2))
                        .add(LootItem.lootTableItem(AetherItems.LIFE_SHARD.get()).setWeight(3))
                        ...
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_PICKAXE.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_SHOVEL.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_GLOVES.get()).setWeight(2))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_HOE.get()))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_HELMET.get()))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_CHESTPLATE.get()))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_LEGGINGS.get()))
                        .add(LootItem.lootTableItem(AetherItems.GRAVITITE_BOOTS.get()))
                        .add(LootItem.lootTableItem(AetherItems.MUSIC_DISC_AETHER_TUNE.get()))
                )
        );
    }
