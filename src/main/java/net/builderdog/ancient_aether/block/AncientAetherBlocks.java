...
public class AncientAetherBlocks extends AncientAetherBlockBuilders {
    ...
    public static final DeferredBlock<Block> CRYSTAL_SKYROOT_SAPLING = register("crystal_skyroot_sapling", () -> new SaplingBlock(AncientAetherTreeGrowers.CRYSTAL_SKYROOT, BlockBehaviour.Properties.ofFullCopy(OAK_SAPLING)));
    public static final DeferredBlock<Block> ENCHANTED_SKYROOT_SAPLING = register("enchanted_skyroot_sapling", () -> new SaplingBlock(AncientAetherTreeGrowers.ENCHANTED_SKYROOT, BlockBehaviour.Properties.ofFullCopy(OAK_SAPLING)));
    public static final DeferredBlock<Block> SKYROOT_PINE_SAPLING = register("skyroot_pine_sapling", () -> new SaplingBlock(AncientAetherTreeGrowers.SKYROOT_PINE_TREE, BlockBehaviour.Properties.ofFullCopy(OAK_SAPLING)));
    public static final DeferredBlock<Block> BLUE_SKYROOT_PINE_SAPLING = register("blue_skyroot_pine_sapling", () -> new SaplingBlock(AncientAetherTreeGrowers.BLUE_SKYROOT_PINE_TREE, BlockBehaviour.Properties.ofFullCopy(OAK_SAPLING)));
    public static final DeferredBlock<Block> HIGHSPROOT_SAPLING = register("highsproot_sapling", () -> new SaplingBlock(AncientAetherTreeGrowers.HIGHSPROOT, BlockBehaviour.Properties.ofFullCopy(OAK_SAPLING)));
    public static final DeferredBlock<Block> SAKURA_SAPLING = register("sakura_sapling", () -> new SaplingBlock(AncientAetherTreeGrowers.SAKURA, BlockBehaviour.Properties.ofFullCopy(OAK_SAPLING)));
    ...
    public static final DeferredBlock<WallBlock> HIGHSPROOT_LOG_WALL = register("highsproot_log_wall", AncientAetherBlocks::logWall);
    public static final DeferredBlock<WallBlock> HIGHSPROOT_WOOD_WALL = register("highsproot_wood_wall", AncientAetherBlocks::logWall);
    public static final DeferredBlock<WallBlock> STRIPPED_HIGHSPROOT_LOG_WALL = register("stripped_highsproot_log_wall", AncientAetherBlocks::logWall);
    public static final DeferredBlock<WallBlock> STRIPPED_HIGHSPROOT_WOOD_WALL = register("stripped_highsproot_wood_wall", AncientAetherBlocks::logWall);
    public static final DeferredBlock<WallBlock> SAKURA_LOG_WALL = register("sakura_log_wall", AncientAetherBlocks::logWall);
    public static final DeferredBlock<WallBlock> SAKURA_WOOD_WALL = register("sakura_wood_wall", AncientAetherBlocks::logWall);
    public static final DeferredBlock<WallBlock> STRIPPED_SAKURA_LOG_WALL = register("stripped_sakura_log_wall", AncientAetherBlocks::logWall);
    ...
    public static final DeferredBlock<DoorBlock> HIGHSPROOT_DOOR = register("highsproot_door", () -> new DoorBlock(AncientAetherBlockSets.HIGHSPROOT_BLOCK_SET, Block.Properties.ofFullCopy(OAK_DOOR)));
    public static final DeferredBlock<TrapDoorBlock> HIGHSPROOT_TRAPDOOR = register("highsproot_trapdoor", () -> new TrapDoorBlock(AncientAetherBlockSets.HIGHSPROOT_BLOCK_SET, Block.Properties.ofFullCopy(OAK_TRAPDOOR)));
    public static final DeferredBlock<ButtonBlock> HIGHSPROOT_BUTTON = register("highsproot_button", () -> new ButtonBlock(AncientAetherBlockSets.HIGHSPROOT_BLOCK_SET, 30, Block.Properties.ofFullCopy(OAK_BUTTON)));
    public static final DeferredBlock<PressurePlateBlock> HIGHSPROOT_PRESSURE_PLATE = register("highsproot_pressure_plate", () -> new PressurePlateBlock(AncientAetherBlockSets.HIGHSPROOT_BLOCK_SET, Block.Properties.ofFullCopy(OAK_PRESSURE_PLATE)));
    public static final DeferredBlock<StandingSignBlock> HIGHSPROOT_SIGN = BLOCKS.register("highsproot_sign", () -> new AncientAetherSignBlock(AncientAetherBlockSets.HIGHSPROOT, BlockBehaviour.Properties.ofFullCopy(OAK_SIGN)));
    public static final DeferredBlock<WallSignBlock> HIGHSPROOT_WALL_SIGN = BLOCKS.register("highsproot_wall_sign", () -> new AncientAetherWallSignBlock(AncientAetherBlockSets.HIGHSPROOT, BlockBehaviour.Properties.ofFullCopy(OAK_WALL_SIGN)));
    public static final DeferredBlock<CeilingHangingSignBlock> HIGHSPROOT_HANGING_SIGN = BLOCKS.register("highsproot_hanging_sign", () -> new AncientAetherCeilingHangingSignBlock(AncientAetherBlockSets.HIGHSPROOT, BlockBehaviour.Properties.ofFullCopy(OAK_HANGING_SIGN)));
    public static final DeferredBlock<WallHangingSignBlock> HIGHSPROOT_WALL_HANGING_SIGN = BLOCKS.register("highsproot_wall_hanging_sign", () -> new AncientAetherWallHangingSignBlock(AncientAetherBlockSets.HIGHSPROOT, BlockBehaviour.Properties.ofFullCopy(OAK_WALL_HANGING_SIGN)));
    ...
    public static final DeferredBlock<DoorBlock> SAKURA_DOOR = register("sakura_door", () -> new DoorBlock(AncientAetherBlockSets.SAKURA_BLOCK_SET, Block.Properties.ofFullCopy(OAK_DOOR)));
    public static final DeferredBlock<TrapDoorBlock> SAKURA_TRAPDOOR = register("sakura_trapdoor", () -> new TrapDoorBlock(AncientAetherBlockSets.SAKURA_BLOCK_SET, Block.Properties.ofFullCopy(OAK_TRAPDOOR)));
    public static final DeferredBlock<ButtonBlock> SAKURA_BUTTON = register("sakura_button", () -> new ButtonBlock(AncientAetherBlockSets.SAKURA_BLOCK_SET, 30, Block.Properties.ofFullCopy(OAK_BUTTON)));
    public static final DeferredBlock<PressurePlateBlock> SAKURA_PRESSURE_PLATE = register("sakura_pressure_plate", () -> new PressurePlateBlock(AncientAetherBlockSets.SAKURA_BLOCK_SET, Block.Properties.ofFullCopy(OAK_PRESSURE_PLATE)));
    public static final DeferredBlock<StandingSignBlock> SAKURA_SIGN = BLOCKS.register("sakura_sign", () -> new AncientAetherSignBlock(AncientAetherBlockSets.SAKURA, BlockBehaviour.Properties.ofFullCopy(OAK_SIGN)));
    public static final DeferredBlock<WallSignBlock> SAKURA_WALL_SIGN = BLOCKS.register("sakura_wall_sign", () -> new AncientAetherWallSignBlock(AncientAetherBlockSets.SAKURA, BlockBehaviour.Properties.ofFullCopy(OAK_WALL_SIGN)));
    public static final DeferredBlock<CeilingHangingSignBlock> SAKURA_HANGING_SIGN = BLOCKS.register("sakura_hanging_sign", () -> new AncientAetherCeilingHangingSignBlock(AncientAetherBlockSets.SAKURA, BlockBehaviour.Properties.ofFullCopy(OAK_HANGING_SIGN)));
    public static final DeferredBlock<WallHangingSignBlock> SAKURA_WALL_HANGING_SIGN = BLOCKS.register("sakura_wall_hanging_sign", () -> new AncientAetherWallHangingSignBlock(AncientAetherBlockSets.SAKURA, BlockBehaviour.Properties.ofFullCopy(OAK_WALL_HANGING_SIGN)));
    ...
    public static final DeferredBlock<Block> BOSS_DOORWAY_CARVED_STONE = register("boss_doorway_carved_stone", () -> new DoorwayBlock(AncientAetherEntityTypes.MUTATED_AECHOR_PLANT::get, Block.Properties.ofFullCopy(LOCKED_CARVED_TILES.get()).noLootTable()));
    ...
    public static final DeferredBlock<Block> VIOLET_AERCLOUD = register("violet_aercloud", () -> new VioletAercloudBlock(Block.Properties.of().mapColor(MapColor.COLOR_PURPLE).instrument(NoteBlockInstrument.FLUTE).strength(0.3F).sound(SoundType.WOOL).noOcclusion().dynamicShape().isRedstoneConductor(AncientAetherBlocks::never).isSuffocating(AncientAetherBlocks::never).isViewBlocking(AncientAetherBlocks::never)));
    public static final DeferredBlock<Block> WIND_BLOWER = register("wind_blower", () -> new WindBlowerBlock(Block.Properties.of().mapColor(MapColor.SNOW).instrument(NoteBlockInstrument.FLUTE).strength(0.3F).sound(SoundType.WOOL).noOcclusion().dynamicShape().isRedstoneConductor(AncientAetherBlocks::never).isSuffocating(AncientAetherBlocks::never).isViewBlocking(AncientAetherBlocks::never)));
